...
function setup(){
  ...
  tRex = createSprite(60,windowHeight-15,20,50);
  ...
  //solo
  solo = createSprite(windowWidth/2,windowHeight-20,windowWidth,20);
  solo.addImage("terra",imagem_solo);
  
   
  solo_invisivel = createSprite(windowWidth/2,windowHeight-10,windowWidth,10);
  ...
  game_over = createSprite(windowWidth/2,windowHeight/2,20,20);
  reiniciar = createSprite(windowWidth/2,game_over.y+50,20,20);
...
function draw(){
  ...
  fill("black");
  text("Pontuação: "+placar,windowWidth/5,20);
...
function gerarNuvens(){
  ...
  if(frameCount%160===0){
    nuvem = createSprite(windowWidth+10,100,20,20);
    ...
    nuvem.lifetime = windowWidth/nuvem.velocityX;
...
function cactosinhos(){
  ...
  if(frameCount%100===50){
   cactos = createSprite(windowWidth+10,windowHeight-35,20,20);            
   ...
   switch(sorteio){
    ...
    cactos.lifetime = windowWidth/cactos.velocityX;
